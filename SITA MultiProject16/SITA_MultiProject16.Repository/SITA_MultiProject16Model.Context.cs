...
namespace SITA_MultiProject16.Repository
{
    ...
    public partial class AirportEntities : DbContext
    {
        ...
        public virtual DbSet<AllowedAirportToAirlineMapp> AllowedAirportToAirlineMapp { get; set; }
        public virtual DbSet<AssignedAirportToAirlineMapp> AssignedAirportToAirlineMapp { get; set; }
